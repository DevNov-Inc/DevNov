      ...
      <header className="headerWrapper">
        <section className="headerLeft">
          ...
          <section className="headerSection">
            <img alt="Denov logo" src="./assets/devnov_logo.png" />
          </section>
        </section>
        ...
        <section className="headerButtons">
          <Button
            ...
            label={
              <>
                <span className="header_label">
                  {TOOL_TIP_MESSAGES.MORE_PROECTS_BTN}
                </span>
                <section className="header_icon">
            ...
            height={"40px"}
            bgColor={
              moreProjectsStatus ? COLOURS.THEME_WHITE : COLOURS.THEME_BLACK
            }
            fgColor={
              !moreProjectsStatus ? COLOURS.THEME_WHITE : COLOURS.THEME_BLACK
            }
